...
set terminal gif animate delay 2 optimize size 680,480
set output "GIF/us_2D_".No.".gif"
...
#set terminal gif animate delay 2 optimize size 480,480
#set output "GIF/p_2D_".No.".gif"
...
#   set terminal png
#   ttt=sprintf("%03d",tt)
#   set output "DATA/PNG/".No."_t".ttt.".png"	

#   time=sprintf("%.2f",t*dt) 
#   set title "t=".time

#   sp "DATA/".No."/us_".t.".dat" matrix not w pm3d
#   tt=tt+1
#}
...
#stats "DATA/".No."/ncell_t.dat" u 2 nooutput
#mmax=int(STATS_max)
...
#   set output "DATA/PNG/".No."_m0_t".ttt.".png"	
#   sp "DATA/".No."/u_".t."_No.0.dat" matrix not w pm3d
...
#   set terminal png
#   ttt=sprintf("%03d",tt)
#   set output "DATA/PNG/p_".No."_t".ttt.".png"	
#   set palette gray
#   sp "../DATA/".No."/p_".t.".dat" matrix not w pm3d
#   tt=tt+1
#}
